...
% backpropagation
culmulativeGradient2 = zeros(size(Theta2));
culmulativeGradient1 = zeros(size(Theta1));
...
for iInput = 1 : m
    ...
    z3 = a2*Theta2';
    a3 = sigmoid(z3);
    delta3 = a3 - yNew(iInput,:);
    delta2 = delta3 * Theta2 .* a2 .* (1-a2);
    delta2 = delta2(2:end);
    culmulativeGradient2 = culmulativeGradient2 + delta3' * a2;
    culmulativeGradient1 = culmulativeGradient1 + delta2' * a1;
end
